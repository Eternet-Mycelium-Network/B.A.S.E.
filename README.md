...
> **Tag [`v0.8.0`](https://github.com/bmcc-DEV/B.A.S.E./releases/tag/v0.8.0)** · plano [Path to v0.9](base-vault/19%20-%20Path%20to%20v0.9/19.00%20-%20Index.md) · [CHANGELOG](CHANGELOG.md):
> UART/SPI (RP goldens) + STM32 Capstone/SPI2 pins/I2C1 + reconstruct honesty + `base hil` EXPERIMENTAL.
> Demo: [Playbook v0.8](base-vault/18%20-%20Path%20to%20v0.8/18.20%20-%20Forensic%20Playbook.md) · `./examples/pilot/run.sh` · `./examples/pilot_stm32/run.sh`.
