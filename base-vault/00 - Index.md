...
**v1.0.0 ✅ · tag [`v1.2.0-rc`](https://github.com/bmcc-DEV/B.A.S.E./releases/tag/v1.2.0-rc) · [[22 - Path to v1.2/22.00 - Index|Path to v1.2]] · [[21 - Path to v1.1/21.00 - Index|Path to v1.1]] · [[20 - Path to v1.0/20.00 - Index|Path to v1.0]] · [[12 - Path to Real/12.02 - Maturity Matrix|Maturity Matrix]]**
...
| [[22 - Path to v1.2/22.00 - Index\|🚀 Path to v1.2]] | docs ✅ · SOW Industrial Gate · `v1.2.0-rc` |
